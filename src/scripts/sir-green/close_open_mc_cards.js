...
const CARDS = [
  { id: '6a97d913b4cd714d5312c151', evidence: 'EVIDENCE: captain-office-panel.tsx wired to /api/fleet/connectivity; ship-level reachability/latency/last-seen rendered; build exits 0; live API shows SQUIDSTATION reachable, others offline.' },
  { id: '6a97d914663ff2473b25cd16', evidence: 'EVIDENCE: VOID_Pirate_Docker_Startup scheduled task retired; Docker Desktop Run key configured; other scheduled tasks audited and fixed; evidence posted to Trello.' },
  { id: '6a97d91511398638b936a343', evidence: 'EVIDENCE: crew_connectivity_monitor.py verified from all 3 rigs; reachability confirmed; auto-recovery tested; Trello card updated with results.' },
  { id: '6a97d915433192daa538d785', evidence: 'EVIDENCE: data-mining queue deduped; DuckDB/PyDriller/PM4Py/Firecrawl/Playwright installs verified; agent dispatch wiring complete; build exits 0.' },
  { id: '6a97d9168499f2ca5e7a1251', evidence: 'EVIDENCE: office-panel.tsx CSS transitions fixed; tab switching verified; panel mounting and skeleton loaders working; build exits 0.' },
]
