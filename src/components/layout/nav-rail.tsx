...
const navGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { id: 'void-fleet', label: 'Fleet ⚓', icon: <OverviewIcon />, priority: true, essential: true },
      { id: 'void-security', label: 'Security 🛡️', icon: <SecurityIcon />, priority: true, essential: true },
      { id: 'void-vault', label: 'Vault 🗄️', icon: <OverviewIcon />, priority: false },
      { id: 'void-monitoring', label: 'Monitoring 📈', icon: <MonitorIcon />, priority: false },
      { id: 'void-hivehealth', label: 'Hive Mind 🐋', icon: <OverviewIcon />, priority: false },
      { id: 'void-market', label: 'Market 📊', icon: <MonitorIcon />, priority: false },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'office', label: 'Captain\'s Office', icon: <OfficeIcon />, priority: false },
